...
public class StringInMemory {
    ...
    public void test5(){// 测试不能通过
        ...
        String s2 = "hel";
        String s3 = "lo";
        String s4 = s2 + s3;//在运行时才决定字符串拼接生成何种对象
        Assert.assertTrue(s1 == s4);
    }
    //字符串拼接，底层是StringBuilder().append().toString()
    ...
    public void test7(){//true
        ...
        String s = new StringBuilder("计算机").append("软件").toString();//对象
        // s.intern()在字符串常量池生成一个引用，指向s指向的对象，"计算机软件"这个字符串是s
    ...
    @Test
    public void test111(){
        //虚拟机会做一些初始化，自己在常量池生成“java”对象  ”敏感字符“
